...
export class MinHeap<T> extends BinomialHeap<T> implements IMinHeap<T>, IClonable<MinHeap<T>>
{
    ...
    protected GetEmptyHeap(): BinomialHeap<T>
    {
...
export class MaxHeap<T> extends BinomialHeap<T> implements IMaxHeap<T>, IClonable<MaxHeap<T>>
{
    protected ComparatorWrapper(a: T, b: T): number 
    {

 ...
 * @returns Response
 */
function HandleSuccessfulServerResponse(fetchRequest: Request, fetchResponse: Response): Response | Promise<Response>
{
...
* @param {Response} fetchResponse Fetch result (server response)
*/
function HandleUnsuccessfulServerResponse(fetchRequest: Request, fetchResponse: Response): Response | Promise<Response>
{
    //OPEN CACHE
    return caches.open(CacheHelper.mainCacheName).then(function (cache: Cache)
    {
